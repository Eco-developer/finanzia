...
export class BudgetPacingItemDto {
  ...
  @ApiProperty({ example: "#F59E0B", description: "Color de la categoría", nullable: true })
  categoryColorHex: string | null;

  @ApiProperty({ example: "film", description: "Icono de la categoría", nullable: true })
  categoryIcon: string | null;

  @ApiProperty({ example: 20000, description: "Límite mensual en céntimos" })
  amountLimitCents: number;

  @ApiProperty({ example: 16500, description: "Total gastado en céntimos en el periodo" })
  spentCents: number;

  @ApiProperty({ example: 3500, description: "Total restante en céntimos" })
  remainingCents: number;

  @ApiProperty({ example: 82.5, description: "Porcentaje del presupuesto consumido" })
  ...
  @ApiProperty({
    ...
    description: "Estado semafórico: ON_TRACK (<70%), WARNING (70-90%), EXCEEDED (>90%)",
  })
