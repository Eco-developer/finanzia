...
export class DebtAmortizationResponseDto {
  ...
  @ApiProperty({
    example: "50000",
    description: "Importe total amortizado en céntimos",
  })
  amountCents: string;

  @ApiProperty({
    example: "45000",
    description: "Cantidad destinada a amortizar capital",
  })
  principalCents: string;

  @ApiProperty({
    example: "5000",
    description: "Cantidad que cubrió intereses",
  })
  interestCents: string;

  @ApiProperty({
    example: "755000",
    description: "Saldo pendiente restante tras el abono",
  })
...
export class DebtResponseDto {
  ...
  @ApiProperty({
    example: "1000000",
    description: "Importe inicial en céntimos",
  })
  initialAmountCents: string;

  @ApiProperty({
    example: "800000",
    description: "Saldo pendiente en céntimos",
  })
  remainingAmountCents: string;

  @ApiProperty({
    example: "200000",
    description: "Total ya pagado en céntimos",
  })
  paidAmountCents: string;

  @ApiProperty({
    example: 20.0,
    description: "Porcentaje de amortización (0 - 100%)",
  })
  progressPercentage: number;

  @ApiProperty({
    example: 650,
    description: "Tasa en puntos básicos (650 = 6.50%)",
  })
  ...
  @ApiProperty({
    example: "4333",
    description: "Interés mensual estimado en céntimos",
  })
  ...
  @ApiPropertyOptional({
    example: null,
    description: "Fecha de liquidación al 100%",
  })
  paidOffAt?: string | null;

  @ApiProperty({
    example: false,
    description: "Bloqueo inmutable al llegar a 100% pagado",
  })
  isImmutable: boolean;
...
export class DebtsSummaryDto {
  ...
  @ApiProperty({
    example: 2,
    description: "Total de deudas liquidadas en historial",
  })
  paidOffDebtsCount: number;

  @ApiProperty({
    example: "1250000",
    description: "Total deuda pendiente consolidada en céntimos",
  })
  totalRemainingCents: string;

  @ApiProperty({
    example: "2000000",
    description: "Total deuda inicial consolidada en céntimos",
  })
  totalInitialCents: string;

  @ApiProperty({
    example: 750,
    description: "Tasa de interés promedio ponderada en puntos básicos",
  })
  weightedAverageRateBasisPts: number;

  @ApiProperty({
    example: "64000",
    description: "Suma de cuotas mínimas mensuales en céntimos",
  })
  totalMonthlyCommitmentCents: string;

  @ApiProperty({
    example: "7820",
    description: "Suma de intereses mensuales devengados en céntimos",
  })
