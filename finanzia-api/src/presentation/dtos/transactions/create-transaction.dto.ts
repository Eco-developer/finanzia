...
export class CreateTransactionDto {
  ...
  @IsNotEmpty({ message: "El accountId es obligatorio" })
  accountId: string;

  @ApiPropertyOptional({
    example: "cat-uuid-supermercado",
    description: "Identificador UUID de la categoría asociada",
  })
  @IsOptional()
  ...
  @ApiProperty({
    ...
    description:
      "Tipo de movimiento monetario: INCOME o EXPENSE (las transferencias usan /transactions/transfer)",
  })
