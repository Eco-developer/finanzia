...
export class CreateAccountDto {
  ...
  @Length(2, 100, { message: 'El nombre de la cuenta debe tener entre 2 y 100 caracteres' })
  name: string;

  @ApiProperty({
    enum: AccountType,
    example: AccountType.CHECKING,
    description: 'Tipo de cuenta financiera: CHECKING, SAVINGS, CREDIT_CARD, CASH, INVESTMENT',
  })
  @IsEnum(AccountType, {
  ...
  @IsOptional()
  @IsInt({ message: 'El saldo inicial debe ser un número entero en céntimos (cero float)' })
  ...
  @Length(3, 3, { message: 'El código de divisa debe constar exactamente de 3 caracteres (ej. EUR, USD)' })
  currency?: string;
}
